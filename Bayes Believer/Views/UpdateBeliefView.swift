  ...
  var body: some View {
    ScrollView {
      VStack {
        ...
        HStack {
          TextField("", value: $belief.observationTrueLikelihood, formatter: formatter)
        ...
        Text("Suppose this is false, how likely is it to observe evidence?")
          ...
          .padding(0.0)
        HStack {
          TextField("", value: $belief.observationFalseLikelihood, formatter: formatter)
            .keyboardType(UIKeyboardType.decimalPad)
            .padding(.horizontal)
            .frame(width: 70, height: 55)
            .background(Color(#colorLiteral(red: 0.921431005, green: 0.9214526415, blue: 0.9214410186, alpha: 1)))
...
struct BeliefUpdateView_Previews: PreviewProvider {
  static var belief = Belief(description: "Preview Belief", prior: 0.5, observationTrueLikelihood: 0.4, observationFalseLikelihood: 0.2)
